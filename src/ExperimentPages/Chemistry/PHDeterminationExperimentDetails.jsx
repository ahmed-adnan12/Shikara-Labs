      ...
      <div className="relative z-10 w-full px-4 sm:px-8 md:px-12 lg:px-[70px] py-16 sm:py-24">
          ...
          <div className="mb-20">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl leading-relaxed">
              Learn to measure the acidity or basicity of solutions using pH paper and universal indicator. Understand the pH scale and practice identifying acidic, neutral, and basic solutions through practical experimentation.
            </p>
