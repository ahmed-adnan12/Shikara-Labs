...
export default function ChemistryTopicsPage() {
  ...
  const experiments = [
    { id: 1, title: "Study of Chemical Reactions", color: 'from-cyan-400 to-blue-600', accent: 'cyan' },
    { id: 2, title: "Determination of pH of Given Solutions Using pH Paper", color: 'from-amber-400 to-orange-600', accent: 'amber' },
    { id: 3, title: "Study of the Cleansing Action of Soap", color: 'from-violet-400 to-purple-600', accent: 'violet' },
  ];
